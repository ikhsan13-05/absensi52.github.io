...
export default function SettingHariLiburTab() {
    ...
    <div className="space-y-5 lg:space-y-6">
      ...
      {data.length === 0 ? (
        ...
        <div className="rounded-[2rem] bg-white p-5 shadow-soft lg:p-6">
          ...
          <button
            onClick={openAdd}
            className="mb-5 inline-flex items-center justify-center gap-2 rounded-2xl bg-indigo-600 px-5 py-3 text-sm font-black text-white shadow-premium"
          >
            <Plus size={18} />
            Tambah Hari Libur
          </button>
